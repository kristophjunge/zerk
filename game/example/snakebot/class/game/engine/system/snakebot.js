 ...
 * snakebot System
 *
 * Provides snakebot controls for jump and run style games.
 *
 * @class snakebot
...
zerk.define({
    ...
    name: 'snakebot.game.engine.system.snakebot',
    ...
    init: function(engine, config) {
        ...
        zerk.parent('snakebot.game.engine.system.snakebot').init.apply(
            this,
            arguments
        );
    ...
    addEntity: function(entity) {
        ...
        zerk.parent('snakebot.game.engine.system.snakebot').addEntity.apply(
            this,
            arguments
        );
    ...
    start: function() {
        ...
        zerk.parent('snakebot.game.engine.system.snakebot').start.apply(
            this,
            arguments
        );
    ...
    stop: function() {
        ...
        zerk.parent('snakebot.game.engine.system.snakebot').stop.apply(
            this,
            arguments
        );
    ...
    update: function() {
        ...
        zerk.parent('snakebot.game.engine.system.snakebot').update.apply();
